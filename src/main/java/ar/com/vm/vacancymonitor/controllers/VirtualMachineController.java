...
public class VirtualMachineController {
	...
	@RequestMapping("/save")
	public String save(@RequestParam String name, @RequestParam String currentIP,
			@RequestParam String installedInstances, @RequestParam String currentUser) {
	...
	public String update(@RequestParam String id, @RequestParam String name, @RequestParam String currentIP,
			@RequestParam String installedInstances) {
	...
	public String take(@RequestParam String id, @RequestParam String currentUser) {
		...
		try {
			virtualMachineService
					.sendSlackPostRequest("El usuario " + currentUser + " ha tomado " + virtualMachine.getName() + ".");
